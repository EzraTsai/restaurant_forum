...
router.get('/', authenticated, (req, res) => res.redirect('/restaurants')) //如果使用者訪問首頁，就導向 /restaurants 的頁面
router.get('/restaurants', authenticated, restController.getRestaurants) //在 /restaurants 底下則交給 restController.getRestaurants 來處理
